...
void Game::DrawGame()
{
    ...
    // Dibujar el cuerpo de caida (bloque)
...
void Game::InitPhysics()
{
    ...
    // Crear el suelo estático del mundo fisico
    b2Body* groundBody = Box2DHelper::CreateRectangularStaticBody(phyWorld, 100, 10);
    groundBody->SetTransform(b2Vec2(50.0f, 100.0f), 0.0f);

    // Crear un bloque
    controlBody = Box2DHelper::CreateRectangularDynamicBody(phyWorld, 20, 10, 1.0f, 0.5, 0.2f);
